function DALTONICS_mando
global CMD
if isempty(CMD), CMD = [47.6;0;0;0]; end
f = figure(100); clf(f);
set(f,'Name','MANDO DALTONICS','Color','w','NumberTitle','off');
...
refresca();
    ...
    function refresca()
        set(txt,'String',sprintf(['   MANDO DALTONICS (deja el foco aqui)\n\n',...
            '   Throttle: %5.1f %%\n   Roll:     %5.1f deg\n',...
            '   Pitch:    %5.1f deg\n   Yaw:      %5.1f dps\n\n',...
